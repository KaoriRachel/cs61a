...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for card_ in player.deck.cards:
            card_.attack += other_card.attack
            card_.defense += other_card.defense

        for card_ in opponent.deck.cards[:]:
            if card_.attack == other_card.attack and card_.defense == other_card.defense:
                opponent.deck.cards.remove(card_)
